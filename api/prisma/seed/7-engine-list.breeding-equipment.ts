...
const generateBreedingEquipmentListSeeder = () => ({
  ...
  imageUrl: 'https://nestjsfileuploadfarmingmachine.s3.eu-west-3.amazonaws.com/desileuse.png',
});

export const ENGINE_LIST_BREEDING_EQUIPMENT = Array.from({ length: 10 }, () =>
  generateBreedingEquipmentListSeeder()
);
