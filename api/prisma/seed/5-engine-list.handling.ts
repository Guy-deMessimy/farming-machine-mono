...
const generateHandlingListSeeder = () => ({
  ...
  typeId: null,
  imageUrl: 'https://nestjsfileuploadfarmingmachine.s3.eu-west-3.amazonaws.com/chargeur-frontal.png',
});

export const ENGINE_LIST_HANDLING = Array.from({ length: 10 }, () =>
  generateHandlingListSeeder()
);
