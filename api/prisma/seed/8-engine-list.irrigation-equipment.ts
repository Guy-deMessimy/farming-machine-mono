...
const generateIrrigationEquipmentListSeeder = () => ({
  ...
  imageUrl: 'https://nestjsfileuploadfarmingmachine.s3.eu-west-3.amazonaws.com/pompe.png',
});

export const ENGINE_LIST_IRRIGATION_EQUIPMENT = Array.from({ length: 10 }, () =>
  generateIrrigationEquipmentListSeeder()
);
