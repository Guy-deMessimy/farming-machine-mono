...
const generateSpecializedEquipmentListSeeder = () => ({
  ...
  typeId: null,
  imageUrl: 'https://nestjsfileuploadfarmingmachine.s3.eu-west-3.amazonaws.com/arracheuse-betterave.png',
});

export const ENGINE_LIST_SPECIALIZED_CULTURE = Array.from({ length: 10 }, () =>
  generateSpecializedEquipmentListSeeder()
);
