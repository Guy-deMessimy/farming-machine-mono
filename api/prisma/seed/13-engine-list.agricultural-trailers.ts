...
const generateAgriculturalTrailersListSeeder = () => ({
  ...
  imageUrl: 'https://nestjsfileuploadfarmingmachine.s3.eu-west-3.amazonaws.com/remorques.png',
});

export const ENGINE_LIST_AGRICULTURAL_TRAILERS = Array.from({ length: 10 }, () =>
  generateAgriculturalTrailersListSeeder()
);
