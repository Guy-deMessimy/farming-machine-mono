...
const generateSeederEquipmentListSeeder = () => ({
  ...
  imageUrl: 'https://nestjsfileuploadfarmingmachine.s3.eu-west-3.amazonaws.com/semoirs.png',
});

export const ENGINE_LIST_SEEDERS_EQUIPMENT = Array.from({ length: 10 }, () =>
  generateSeederEquipmentListSeeder()
);
