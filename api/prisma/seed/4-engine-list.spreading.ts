...
const generateSpreadingListSeeder = () => ({
  ...
  typeId: null,
  imageUrl: 'https://nestjsfileuploadfarmingmachine.s3.eu-west-3.amazonaws.com/epandeur.png',
});

export const ENGINE_LIST_SPREADING = Array.from({ length: 10 }, () =>
  generateSpreadingListSeeder()
);
