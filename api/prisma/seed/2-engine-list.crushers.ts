...
const generateCrushersListSeeder = () => ({
  ...
  imageUrl: 'https://nestjsfileuploadfarmingmachine.s3.eu-west-3.amazonaws.com/broyeuse.png',
});

export const ENGINE_LIST_CRUSHERS = Array.from({ length: 10 }, () =>
  generateCrushersListSeeder()
);
